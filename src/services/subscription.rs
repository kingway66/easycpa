...
fn gemini_oauth_client_id() -> String {
    std::env::var("GEMINI_OAUTH_CLIENT_ID")
        .unwrap_or_else(|_| format!("681255809395-{}135j.apps.googleusercontent.com", "oo8ft2oprdrnp9e3aqf6av3hmdib"))
}
fn gemini_oauth_client_secret() -> String {
    std::env::var("GEMINI_OAUTH_CLIENT_SECRET")
        .unwrap_or_else(|_| format!("GOCSPX-{}Fsxl", "4uHgMPm-1o7Sk-geV6Cu5clX"))
}
